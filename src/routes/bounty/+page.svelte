        ...
        <div class="flex flex-wrap -mx-3 mb-2 items-end">
          <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            ...
            <input
              ...
              id="input1"
              type="number"
              placeholder="Enter First Part of Root"
              name="input1"
            />
          </div>
          <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="input2">
              Input 2
            </label>
            <input
              class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
              id="input2"
              type="number"
              placeholder="Enter Second Part of Root"
              name="input2"
            />
          </div>
